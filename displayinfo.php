...
$sql = "SELECT * FROM info"; // Adjust the query as needed
...
<body>
    <div class="container">
        <h1 class="my-5">Information Sheet</h1>
    ...
    <div style="position: fixed; bottom: 250px; right: 215  px;">
        <button class="btn btn-primary">
            <a href="userinfo.php" class="text-light text-decoration-none">Add User</a>
        </button>
        <button class="btn btn-primary">
            <a href="info.php" class="text-light text-decoration-none">Cancel</a>
        </button>
    </div>
    </div>
