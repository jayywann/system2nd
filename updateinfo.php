...
if (isset($_GET['id'])) {
    ...
    $stmt = $con->prepare("SELECT * FROM info WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   // Prepare the SQL statement to update the record
$stmt = $con->prepare("UPDATE info SET 
...
$time_in2, $time_out2, $total_pc2, $id);
    ...
    if ($stmt->execute()) {
        ...
        header("Location: displayinfo.php?message=Record+updated+successfully");
...
<body>
    ...
    <a href="info.php" class="btn btn-secondary">Cancel</a>
</form>
